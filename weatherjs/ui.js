class UI{
    ...
    paint(weather){
        ...
        this.desc.textContent = `${weather.responsePost.weather[0].main} -  ${weather.responsePost.weather[1].main}`;
        ...
        document.querySelector(".main-bg").classList.add(`${weather.responsePost.weather[0].main}`);
    }
}